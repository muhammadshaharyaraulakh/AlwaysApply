...
>
  ...
  >
    <div class="w-full lg:w-1/2 z-10 flex flex-col">
      <h1
        class="text-3xl md:text-5xl lg:text-5xl font-semibold text-brand-purple leading-tight mb-6 mt-6"
      >
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      ...
      >
        <div class="flex justify-between items-start mb-4">
          <div>
            ...
            <span class="text-gray-500 text-xs ml-2"
              >Salary: 20,000 INR - 25,000 INR</span
            >
          </div>
          <i
            class="fa-regular fa-bookmark text-gray-400 cursor-pointer hover:text-brand-purple"
          ></i>
        </div>
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500">
              <i class="fa-solid fa-location-dot mr-1"></i> New Delhi, India
            </p>
          </div>
        </div>
        ...
        <div class="flex justify-between items-center mt-6">
          <div class="flex -space-x-2">
            ...
            <img
              ...
              alt=""
            />
            <span class="text-xs text-gray-500 self-center ml-2 pl-1"
              >10+ applicants</span
            >
          </div>
        </div>
        ...
        <div class="flex gap-3 mt-6">
          <button
            class="flex-1 py-2 border border-gray-300 rounded text-sm font-medium hover:border-brand-purple hover:text-brand-purple transition"
          >
            View details
          </button>
          <button
            class="flex-1 py-2 bg-brand-purple text-white rounded text-sm font-medium hover:bg-brand-dark transition"
          >
            Apply now
          </button>
        </div>
      ...
      >
        <div class="flex justify-between items-start mb-4">
          <div>
            ...
            <span class="text-brand-purple text-xs font-bold uppercase"
              >Full-Time</span
            >
            <span class="text-gray-500 text-xs ml-2"
              >Salary: $30,000 - $55,000</span
            >
          </div>
          <i
            class="fa-regular fa-bookmark text-gray-400 cursor-pointer hover:text-brand-purple"
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500">
              <i class="fa-solid fa-location-dot mr-1"></i> Boston, USA
            </p>
          </div>
        </div>
      ...
      >
        <div class="flex justify-between items-start mb-4">
          <div>
            ...
            >
            <span class="text-gray-500 text-xs ml-2"
              >Salary: 15,000 INR - 35,000 INR</span
            >
          </div>
          <i
            class="fa-regular fa-bookmark text-gray-400 cursor-pointer hover:text-brand-purple"
        ...
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500">
              <i class="fa-solid fa-location-dot mr-1"></i> Bangalore, India
            </p>
          </div>
        </div>
