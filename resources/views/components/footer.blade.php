    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
      ...
      <div data-aos="fade-up">
        ...
        <div class="text-sm text-gray-500 space-y-2">
          <p class="leading-relaxed mt-2">
            Noor Colony Jinnah Town ,4/10L , Harappa Station 57160 , Sahiwal Punjab Pakistan.
          </p>
        </div>
      </div>
      ...
      <div data-aos="fade-up" data-aos-delay="100">
        ...
        <ul class="space-y-2 text-sm text-gray-500">
          <li><a href="#" class="hover:text-brand-purple transition">Home</a></li>
          <li><a href="#" class="hover:text-brand-purple transition">Find Jobs</a></li>
          <li><a href="#" class="hover:text-brand-purple transition">Profile</a></li>
          <li><a href="#" class="hover:text-brand-purple transition">Applications</a></li>
          <li><a href="#" class="hover:text-brand-purple transition">Contact</a></li>
        </ul>
      </div>
